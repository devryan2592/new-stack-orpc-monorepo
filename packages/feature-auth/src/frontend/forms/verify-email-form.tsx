  ...
  if (status === VerificationStatus.SUCCESS) {
    return (
      <div className="flex flex-col items-center justify-center space-y-4 p-8">
        ...
        <p className="text-center text-muted-foreground">Your email has been successfully verified. You can now sign in to your account.</p>
        <div className="text-center space-y-2">
          <p className="text-xs text-muted-foreground">Redirecting to login page in {countdown} seconds...</p>
          <Link href={loginUrl} className="text-xs text-primary hover:underline inline-block">
    ...
    return (
      <div className="flex flex-col items-center justify-center space-y-4 p-8">
        ...
        <div className="text-center">
          <p className="text-xs text-muted-foreground">Need help? Contact our support team or try signing up again.</p>
        </div>
      </div>
    );
  }
